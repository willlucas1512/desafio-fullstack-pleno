...
const AREA_COLORS = {
  saude: "hsl(var(--chart-1))", // azul escuro
  educacao: "hsl(var(--chart-2))", // azul médio
  assistencia_social: "hsl(var(--chart-3))", // azul ciano
} as const;
...
export function AlertsByAreaChart({ data }: { data: AlertsByArea }) {
  const series = [
    {
      key: "saude",
      area: AREA_LABEL.saude,
      value: data.saude,
      color: AREA_COLORS.saude,
    },
    {
      key: "educacao",
      area: AREA_LABEL.educacao,
      value: data.educacao,
      color: AREA_COLORS.educacao,
    },
    {
  ...
  return (
    <div
      ...
      role="img"
      aria-label="Quantidade de crianças com alerta por área"
    >
      <ResponsiveContainer width="100%" height="100%">
        <BarChart
          data={series}
          margin={{ top: 24, right: 10, bottom: 0, left: 0 }}
        >
