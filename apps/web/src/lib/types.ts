...
// --- Auth / erros ---
export type AuthTokenResponse = Json<
  paths["/auth/token"]["post"]["responses"]["200"]
>;
export type ApiErrorBody = Json<
  paths["/auth/token"]["post"]["responses"]["400"]
>;
