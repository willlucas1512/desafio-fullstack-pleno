...
/**
 * Gera o documento OpenAPI a partir dos schemas Zod das rotas e  grava em `apps/api/openapi.json`.
 * O front consome esse arquivo via `openapi-typescript` pra derivar seus tipos.
 *
 * Sobe o app só pra extrair o doc (`app.swagger()`), com um store in-memory
 * vazio e um env mínimo.
 */
const env: Env = {
  NODE_ENV: "test",
  PORT: 3001,
